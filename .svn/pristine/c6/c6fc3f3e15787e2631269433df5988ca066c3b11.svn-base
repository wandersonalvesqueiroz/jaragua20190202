...
<section class="blog-featured<?php echo $this->pageclass_sfx; ?>">
    ...
    <?php if($this->params->get('menu-text_link')): ?>
        <div>
            <a href="<?= JRoute::_(ContentHelperRoute::getCategoryRoute($this->item->catid)) ?>">
                <?= $this->params->get('menu-text_link') ?> <i class="fas fa-angle-double-right"></i>
            </a>
        </div>
    <?php endif; ?>
</section>
